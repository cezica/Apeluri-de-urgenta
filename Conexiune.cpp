...
void Conexiune::trimite_raspuns(string raspuns)
{
...
{
	listener.listen(2001); //se conecteaza la portul 2000
	...
	while (true)
	{
						...
						if (received > 0)	//daca primesc ceva de la client
						{
							...
							if (P->obtine_eroare() == 0) {
								P->rezultat();
								trimite_raspuns(P->obtine_raspuns());
							}
							else {
